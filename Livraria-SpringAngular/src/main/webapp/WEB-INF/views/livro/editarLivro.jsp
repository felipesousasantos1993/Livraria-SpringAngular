...
<script type="text/javascript" src="<spring:url value="/resources/js/livro/editarLivroController.js"/>"></script>
...
<body>
	...
	<form ng-controller="editarRegistroController">
		...
		<input type="checkbox" id="input-registroAtivo" ng-model="ativo" ng-init='${usuarioModel.ativo ? "ativo=true" : ""}' ng-true-value="true"
			ng-false-value="" />
		<br /> <br />
